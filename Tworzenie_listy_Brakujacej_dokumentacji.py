...
# aplication folder (dla PyInstaller)
...
doc.add_paragraph("Lista brakujących dokumentów").runs[0].bold = True
doc.paragraphs[-1].runs[0].font.size = Pt(16)

# recurent searching folders
...
output_path = desktop / "Lista brakującej dokumentacji.docx"
